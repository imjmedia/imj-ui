  ...
  switch (type) {
    case "precio":
      return (
        <div
          className={
            "PrecioCards AlignLeft FontColor" + getColorMedio(props.tipoMedio)
          }
        >
          <p>Precio:</p>
          <h2>{"$" + (props.precio || "0") + ".00"}</h2>
        </div>
      );
    case "costo":
      return (
        <div
          className={
            "CostoCards AlignRight FontColor" + getColorMedio(props.tipoMedio)
          }
        >
          <p>Costo:</p>
          <h2>{"$" + (props.costo || "0") + ".00"}</h2>
        </div>
      );
    case "precioCosto":
      return (
